    ...
    <div class="col-md-<?php devdmbootstrap3_main_content_width(); ?> dmbs-main">
			...
			<div class="container-fluid">
				<div class="school-distribution-container container-fluid">
					<div class="col-sm-4 col-xs-12 school-distribution">
						<ul>
							<li><a href="<?php bloginfo('url'); ?>/recommended-schools/?location=nsw"><span class="text-right">新南威尔士州</span><span class="text-center">NSW</span></a></li>
							<li><a href="<?php bloginfo('url'); ?>/recommended-schools/?location=vic"><span class="text-right">维多利亚州</span><span class="text-center">VIC</span></a></li>
							<li><a href="<?php bloginfo('url'); ?>/recommended-schools/?location=qld"><span class="text-right">昆士兰州</span><span class="text-center">QLD</span></a></li>
							<li><a href="<?php bloginfo('url'); ?>/recommended-schools/?location=sa"><span class="text-right">南澳大利亚州</span><span class="text-center">SA</span></a></li>
							<li><a href="<?php bloginfo('url'); ?>/recommended-schools/?location=wa"><span class="text-right">西澳大利亚州</span><span class="text-center">WA</span></a></li>
							<li><a href="<?php bloginfo('url'); ?>/recommended-schools/?location=act"><span class="text-right">首都特区</span><span class="text-center">ACT</span></a></li>
							<li><a href="<?php bloginfo('url'); ?>/recommended-schools/?location=nt"><span class="text-right">北领地</span><span class="text-center">NT</span></a></li>
							<li><a href="<?php bloginfo('url'); ?>/recommended-schools/?location=tas"><span class="text-right">塔斯马尼亚</span><span class="text-center">TAS</span></a></li>
						</ul>
					</div>
					<div class="col-sm-8 col-xs-12 school-map">
						<p class="text-center"><img src="<?php echo bloginfo('template_url'); ?>/img/state.png" /></p>
						...
						<p class="hidden text-center"><img src="<?php echo bloginfo('template_url'); ?>/img/qld.png" /></p>
		...
		<div class="school-category-block main-content row">
			<div class="container-fluid school-category-header">
				...
				<h1><?php $category = get_category_by_slug( 'recommended-school' ); echo $category->name; ?><h1>
				</div>
			...
			<?php 
				...
				if($_GET['sort'] == 'title') {
					$args = array(
					'category_name' 	=> 'recommended-school', $_GET['location'] ? $_GET['location'] : '',
					'posts_per_page' 	=> 5,
					'orderby'			=> 'title',
