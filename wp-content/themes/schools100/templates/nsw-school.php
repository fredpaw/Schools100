    ...
    <div class="col-md-<?php devdmbootstrap3_main_content_width(); ?> dmbs-main">
			...
			<div class="container-fluid">
				<div class="school-distribution-container container-fluid">
					<div class="col-sm-4 col-xs-12 school-distribution">
						<ul>
							<li class="active"><a href="<?php bloginfo('url'); ?>/new-south-wales-schools/"><span class="text-right">新南威尔士州</span><span class="text-center">NSW</span></a></li>
							<li><a href="<?php bloginfo('url'); ?>/victoria-schools/"><span class="text-right">维多利亚州</span><span class="text-center">VIC</span></a></li>
							<li><a href="<?php bloginfo('url'); ?>/queensland-schools/"><span class="text-right">昆士兰州</span><span class="text-center">QLD</span></a></li>
					...
					<div class="col-sm-8 col-xs-12 school-map">
						<p class="text-center"><img src="<?php echo bloginfo('template_url'); ?>/img/nsw.png" /></p>
		...
		<div class="school-category-block main-content row">
			<div class="container-fluid school-category-header">
				...
				<h1><?php $category = get_category_by_slug( 'nsw' ); echo $category->name; ?><h1>
				</div>
