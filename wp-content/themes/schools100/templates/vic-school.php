    ...
    <div class="col-md-<?php devdmbootstrap3_main_content_width(); ?> dmbs-main">
				...
				<div class="school-distribution-container container-fluid">
					<div class="col-sm-4 col-xs-12 school-distribution">
						<ul>
							...
							<li class="active"><a href="<?php bloginfo('url'); ?>/victoria-schools/"><span class="text-right">维多利亚州</span><span class="text-center">VIC</span></a></li>
					...
					<div class="col-sm-8 col-xs-12 school-map">
						...
						<p class="text-center"><img src="<?php echo bloginfo('template_url'); ?>/img/vic.png" /></p>
		...
		<div class="school-category-block main-content row">
			<div class="container-fluid school-category-header">
				...
				<h1><?php $category = get_category_by_slug( 'vic' ); echo $category->name; ?><h1>
				</div>
