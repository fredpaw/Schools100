    ...
    <div class="col-md-<?php devdmbootstrap3_main_content_width(); ?> dmbs-main">
			...
			<div class="container-fluid">
				<div class="school-category-container container-fluid">
					<div class="col-sm-3 col-xs-12 school-category-type">
						<ul>
							<li><a href="<?php bloginfo('url'); ?>/missionary-school/">教会中学</a></li>
							<li><a href="<?php bloginfo('url'); ?>/public-school/">公立中学</a></li>
							<li><a href="<?php bloginfo('url'); ?>/private-school/">私立中学</a></li>
							<li><a href="<?php bloginfo('url'); ?>/elite-school/">贵族中学</a></li>
							<li class="active"><a href="<?php bloginfo('url'); ?>/international-school/">国际中学</a></li>
							<li><a href="<?php bloginfo('url'); ?>/boy-school/">男子中学</a></li>
							<li><a href="<?php bloginfo('url'); ?>/girl-school/">女子中学</a></li>
							<li><a href="<?php bloginfo('url'); ?>/mixed-school/">混合中学</a></li>
							<li><a href="<?php bloginfo('url'); ?>/specialty-school/">特长中学</a></li>
							<li><a href="<?php bloginfo('url'); ?>/ib-school/">IB中学</a></li>
							<li><a href="<?php bloginfo('url'); ?>/boarding-school/">寄宿中学</a></li>
							<li><a href="<?php bloginfo('url'); ?>/university-foundation/">大学预科</a></li>
						</ul>
					</div>
					...
					?>
						<div class="school-intro-block">
							<div class="school-intro">
								<div class="school-intro-title" id="title-5"><a href="<?php the_permalink(); ?>"><h3 class="text-center"><?php the_title();?></h3></a></div>
		...
		<div class="school-category-block main-content row">
			<div class="container-fluid school-category-header">
				...
				<h1><?php $category = get_category_by_slug( 'international-school' ); echo $category->name; ?><h1>
				</div>
			...
			<?php 
				...
				if($_GET['sort'] == 'title') {
					$args = array(
					'category_name' 	=> 'international-school',
					'posts_per_page' 	=> 5,
					'orderby'			=> 'title',
