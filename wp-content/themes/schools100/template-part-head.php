    ...
    <div id="divFloatToolsView" class="floatR">
        ...
        <div class="cn">
            <ul>
                ...
                <li><span class=>(02) 9267 7239</span> </li>
                <li>
                ...
                <li><span class="">(03) 9614 6026</span> </li>
                <li>
                ...
                <li><span class=>010-59003028</span> </li>
...
<?php if ($dm_settings['show_header'] != 0) : ?>
    <div class="dmbs-header row">
        ...
        <?php if ( get_header_image() != '' ) : ?>
            <div class="col-md-12 col-sm-4 hidden-xs dmbs-header-img text-center">
        ...
        <div class="hidden-lg hidden-md col-sm-8 dmbs-header-text">
